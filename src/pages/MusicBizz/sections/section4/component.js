...
import mockupBg from "../../../../assets/illustration/bizz_desktop.jpg";
import mockupMobBg from "../../../../assets/illustration/bizz_mobile.jpg";
        ...
        <Grid item xs={12} md={8}>
          <Fade duration="1500" direction="up" triggerOnce>
            <h1 className={clsx(classes.header1, classes.spacingBottom)}>
              Ini manfaat yang bisa kamu dapatkan lewat Music Bizz
            </h1>
          </Fade>
        </Grid>
              ...
              <Fade duration="1500" direction="right" triggerOnce>
                <Grid container justify="flex-end">
                  <Grid item xs={12}>
                    ...
                    >
                      Download sekarang untuk mencoba Music Bizz. Gratis!
                    </h1>
                  </Grid>
                  <Grid item>
                    <Grid
